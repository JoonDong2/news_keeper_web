var TemrsOfUse = `
**Welcome to News Manager!**

News Manager develops technologies and services that enable people to interact with each other, build communities and grow their business. Unless otherwise stated that separate terms (other than these terms) apply, these terms apply to your use of products, features, apps, services, technologies, and software (June Lab products or products) provided by News Manager. These products are provided by JunLab.

## 1. Services provided by News Manager
...
In News Manager products used by users, we support users to easily write and check brief information and handwritten text about the content of specific pages accessed from the internal browser. In order to realize this, when a user writes and checks the text, the category entered by the user who is currently connected or who accessed when writing the text, the address of the Internet page, the title of the page extracted from the meta tag of the corresponding Internet page, Information (direct link) including summary and representative image is shared together.

> **Connect with people and organizations that are important to you.**

In the News Manager products you use, we allow you to share text you write with direct links to other users, and to connect with other users' activities in News Manager (e.g. like/dislike, comment).

We help you find and connect with the people, groups, businesses, organizations and many other things that matter to you in the News Manager products you use. We use the data we hold to make offers to you and others (e.g. pages to subscribe to or send messages to, programs you want to see, and offers you might want to make friends with). Closer relationships create a better community. We believe that News Manager services are most valuable when people connect with the people, groups and organizations they care about.

> **It provides the ability for users to express themselves and to share what users value.**

There are many ways in News Manager to express yourself and share what you value with friends, family, and others (e.g., share photos, stories from your News Manager product, send messages to friends or multiple people, Add content to your profile).

> **We help users find content, products and services that may interest them.**

Displays advertisements, offers, and other promotional content to help you discover the content, products, and services offered by many businesses and organizations that use News Manager products.

> **Prevent harmful behavior and protect and support the community.**

People form communities in News Manager only when they feel safe. With dedicated teams around the world, we develop state-of-the-art technology systems to detect misuse of our products, harm to others, and situations in which we may support or protect our community. If we discover such content or conduct, we will take appropriate action (e.g., providing assistance, removing content, removing or restricting access to certain features, deactivating your account, or contacting law enforcement authorities).
...
## 2. How the News Manager service is funded
News Manager does not charge you for use of News Manager or any other products and services covered by these Terms. Instead, advertisers pay us to advertise their products and services to users. By using the News Manager product, you agree to show us advertisements that we believe are relevant to you or are relevant to your interests. We use keywords extracted from personal data, excluding text entered by users, to determine the advertisements to be shown to users.

**Personal data** is information **that includes the address of an Internet page that you bookmarked or clipped from News Manager's internal browser, the title extracted from that page's meta tag, a summary of content, and text entered by the user.**

## 3. How the News Manager service protects your personal information
...
News Manager privacy is a key consideration when designing a system.
...
The user's personal information received from the server to the user's terminal is stored in the keystore in the case of News Manager Android application, and in the keychain in case of News Manager iOS application.

Both Android's Keystore and iOS's Keychain are storage spaces with strong security features.

News Manager Android and iOS applications do not contain logic to upload users' personal data to the server without user interaction.

## 4. News Manager and Commitment to Community

We provide services to users and others to realize News Manager's mission. In this regard, the user must make the following promise.

> Who can use News Manager

When people take responsibility for their opinions and actions, the News Manager community becomes a safer and more reliable space. For this reason, the following must be observed: 
   ...
   * You must not grant access to your News Manager account to others, or transfer your account to another person (without our permission).

We endeavor to make News Manager widely available, but News Manager is not available if you: 
   ...
   * When a user's use of News Manager products, services or software is prohibited in accordance with applicable laws

> What you can and can do with News Manager

We want people to use News Manager to express themselves and share content that is important to them, but this does not compromise the safety and well-being of others or the integrity of our community. Accordingly, you agree not to engage in any of the actions described below (or any actions that enable or support others to do so).

You may not use our products to do or share any of the following:
   * Actions that violate these Terms, Community Rules, and other terms and policies that apply to your use of News Manager
   ...
   * You may not use automated means (without our prior permission) to access or collect data from News Manager products, and must not attempt to access data for which you do not have access rights.
...
We will do so if we believe it is necessary to delete or restrict access to your content, services or information in order to avoid or reduce situations that are legally unfavorable to News Manager or affecting regulations.

> Authority granted to us by users

User permission is required to provide News Manager service:
...
1. Rights to contents created and shared by users
   ...
   You own the intellectual property rights (such as copyright or trademark) of the content you create and share in News Manager company products. Nothing in these Terms deprives you of your rights to your own content, and you can freely share your content with others wherever you want.
...
2. Personal data, excluding text entered by users, and information about activities in News Manager (eg, likes/dislikes, comments) may be displayed with or in association with advertisements, offers and other sponsored content displayed throughout our products Grants to us free of charge.
...
4. Restrictions on News Manager's Use of Intellectual Property
...
We are constantly improving our services and developing new features to make better products for our users and the News Manager community. Accordingly, we may need to update these Terms from time to time to accurately reflect our services and practices. We will make changes to these Terms and Conditions only if such provisions are no longer appropriate or incomplete, and if the changes are reasonable and adequately consider the interests of users.
   
The latest version of this policy applies to the processing of your personal data by us, which will always be posted at https://news-keeper.joon-lab.com/terms_of_use/en or the latest version of the News Manager application.
   
Unless otherwise required by law, we will notify you prior to making any changes to these Terms, and give you the opportunity to review them at least 30 days before the changed terms become effective. When the updated terms and conditions become effective, if the user continues to use the News Manager product after the effective date of the change, the user is subject to the revised terms and conditions.
   
We hope that you will continue to use our products, but you can delete your account at any time if you do not agree to the updated terms and you no longer wish to participate in the News Manager community.

> **Account suspension or termination**

We want News Manager to be a place where people feel welcomed and safe to express themselves and share their thoughts and ideas.

You may suspend or permanently disable access to your account if you believe that you have clearly, seriously or repeatedly violate News Manager's terms or policies, including in particular News Manager's Community Rules. You can also suspend or deactivate your account if you have repeatedly infringed on someone else's intellectual property rights or if it is necessary for legal reasons.

If we take such action, we may expose News Manager or a third party to legal liability, harm the News Manager user community, damage or interfere with the integrity or operation of News Manager's sources, systems or products, or due to technical limitations. We are pleased to inform you and explain all options for you to request a review of these actions by us, only to the extent not limited by or legally prohibited.
...
News Manager is dedicated to providing the best products while providing clear guidance to everyone who uses them. However, the News Manager product is provided'as is', and we do not guarantee that it will **at all times be secure, secure and error-free, and that it will always function without interference, delays or defects.** To the extent permitted by law, we also make no warranties of any kind, including, but not limited to, the implied warranties of merchantability, fitness for a particular purpose, title, and non-infringement.** We do not monitor or control people's activities and conversations, and do not monitor or control people's activities (online or offline) or content shared by people (including offensive, inappropriate, obscene, illegal, and other objectionable content). I am not responsible.**

We cannot predict when problems will occur with News Manager products. Accordingly, our liability is limited to the extent permitted by applicable law, and in any case, loss of profits, profits, information or data arising from these Terms or in connection with the **News Manager product, or loss of derivative, special, indirect, exemplary, The user is not liable for punitive or incidental damages.** This is true even if we have been advised of the possibility of such damages.

**News Manager uses your Cellular or WIFI to access the Internet. We are not responsible for the Cellular charges used to access the Internet. To prevent this, you need to use WIFI or stop using the app.**

However, in spite of this, the limitation or exemption from the liability set forth above may not be permitted under applicable laws. In this case, News Manager is liable to the extent prescribed by applicable law.

> **Etc**

1. These Terms (previously titled: Policy on Rights and Responsibilities) constitute the complete agreement between you and JunLab with respect to your use of News Manager products. These terms and conditions supersede all previous agreements.
2. Some of the products we offer are also subject to additional terms and conditions. If you use the product, additional terms and conditions will be provided to you and the additional terms form part of the agreement between us and you. For example, if a user accesses or uses News Manager products for commercial or business purposes (e.g., buying advertisements, selling products, developing apps), they must agree to the Terms of Commerce. To the extent that the additional terms conflict with these terms, the additional terms take precedence.
...
7. We welcome comments and suggestions for News Manager products and services. However, we inform you that we may use it without any restrictions or obligations to compensate and we have no obligation to keep it confidential.
