...
> **기본 계정정보**
   ...
   **회원가입은 구글 또는 카카오같은 소셜 인증업체를 통해 얻은 정보로만 진행됩니다.** 귀하는 소셜 인증업체에 등록된 자신의 **고유번호, 이름, 이메일, 사진** 정보를 제공해야 합니다.
...
> **연락처**
   ...
   당사는 귀하의 이메일을 사용하여 사용자의 문의에 대한 답변을 전달합니다.
   
   당사는 귀하의 이메일을 사용하여 계정 정지 및 정지 사유와 같은 중요한 메세지를 전달합니다.
...
당사는 본 개인정보처리방침을 수시로 개정할 수 있습니다. 본 방침의 최신 버전이 당사에 의한 귀하의 개인 데이터 처리에 적용되며 동 방침은 https://news-keeper.joon-lab.com/privacy.html 또는 최신 버전의 News Keeper 어플리케이션에 항상 게시됩니다. 당사의 재량으로 판단할 때 본 방침의 개정이 중대한 경우, 당사는 귀하에게 귀하의 계정과 연결된 이메일을 통해 고지할 것입니다. 귀하는 개정된 본 방침이 시행된 후 당사의 서비스에 계속 액세스하거나 이를 이용함으로써 개정된 개인정보처리방침에 구속되는 것에 동의하게 됩니다.
