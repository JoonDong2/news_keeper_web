...
We believe that you should always be aware of what data News Manager collects and how it uses the data it collects, and that you have practical control over all of this. We want to empower you to make the best decisions about the information you share with us.

## 2. Information shared with us
We need certain information to provide services to you. For example, you must have an account to share content on News Manager. If you choose to share the information below with us, we collect and use it to operate our services.

> **Basic account information**

You do not need to create an account in order to use some service features, such as checking clippings shared by other users in News Manager.
...
Your information registered with News Manager is synchronized with the authenticator each time you log in.

Your name and photo are always public, but users can use their real name or pseudonym.

> **Public information**

   Among the information you provided when signing up for News Manager, your name and photo will be disclosed to other users.

   Channel introductory text that you have set up in News Manager is made public to other users.

   Text (clippings) for certain Internet pages that you have set up to share directly in News Manager are disclosed to other users. You can share the clipping when saving it, or by activating the "Share" button on the clipping detail page (shown with a blue background). In this case, the category you set yourself and a direct link including the title, summary and representative image of the page extracted from the meta tag of that Internet page will be shared.
...
> **Direct messages and private communication**
   ...
   If you communicate using features such as Direct Messages, even if you delete a copy of these Direct Messages from your account, we will retain a copy of your communication in the recipient's News Manager, so the content may be duplicated, archived or shared again. Do not forget that there is.
...
As mentioned above, News Manager is designed to distribute the information you publicly share through our services in a broad and immediate way. In some cases where we disclose your private personal data, we do so under your control. Because doing so is important or required by law for the operation of our services.
...
From the clippings you have saved or liked or disliked, the keyword extracted from the title and content summary of the page, extracted from the metadata of the specific Internet page associated with that clipping, is passed to the'Google AdMob', which processes ads in News Manager. Keywords are used by'Google Admob' to show you the ads that work best for you.
