...
당사는 본 개인정보처리방침을 수시로 개정할 수 있습니다. 본 방침의 최신 버전이 당사에 의한 귀하의 개인 데이터 처리에 적용되며 동 방침은 https://news-keeper.joon-lab.com/privacy_kr.html 또는 최신 버전의 News Keeper 어플리케이션에 항상 게시됩니다. 귀하는 개정된 본 방침이 시행된 후 당사의 서비스에 계속 액세스하거나 이를 이용함으로써 개정된 개인정보처리방침에 구속되는 것에 동의하게 됩니다.
